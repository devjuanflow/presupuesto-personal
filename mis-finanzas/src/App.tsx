        ...
        {activeTab === 'budget' ? (
          ...
          <>
            ...
            <form onSubmit={handleGoalSubmit} className={`p-4 rounded-2xl shadow-sm mb-5 flex flex-col gap-3 border transition-colors ${darkMode ? 'bg-gray-900 border-gray-800' : 'bg-white border-gray-100'} ${editingGoalId ? 'border-emerald-500' : ''}`}>
              ...
              <input type="text" inputMode="numeric" placeholder="Monto objetivo total" value={newGoalTarget} onChange={e => setNewGoalTarget(formatInputCurrency(e.target.value))} className={`p-3 border rounded-xl text-sm outline-none font-medium transition-colors ${darkMode ? 'bg-gray-800 border-gray-700 text-white placeholder-gray-500' : 'bg-white border-gray-200 text-gray-800'}`} />
              <input type="text" inputMode="numeric" placeholder="Monto actual ahorrado" value={newGoalCurrent} onChange={e => setNewGoalCurrent(formatInputCurrency(e.target.value))} className={`p-3 border rounded-xl text-sm outline-none font-medium transition-colors ${darkMode ? 'bg-gray-800 border-gray-700 text-white placeholder-gray-500' : 'bg-white border-gray-200 text-gray-800'}`} />
          ...
          <>
            ...
            <form onSubmit={handleDebtSubmit} className={`p-4 rounded-2xl shadow-sm mb-5 flex flex-col gap-3 border transition-colors ${darkMode ? 'bg-gray-900 border-gray-800' : 'bg-white border-gray-100'} ${editingDebtId ? 'border-orange-500' : ''}`}>
              ...
              <div className="grid grid-cols-2 gap-2">
                <input type="text" inputMode="numeric" placeholder="Monto Total" value={newDebtTotal} onChange={e => setNewDebtTotal(formatInputCurrency(e.target.value))} className={`p-3 border rounded-xl text-sm outline-none transition-colors ${darkMode ? 'bg-gray-800 border-gray-700 text-white placeholder-gray-500' : 'bg-white border-gray-200 text-gray-800'}`} />
                <input type="text" inputMode="numeric" placeholder="Monto Pagado" value={newDebtPaid} onChange={e => setNewDebtPaid(formatInputCurrency(e.target.value))} className={`p-3 border rounded-xl text-sm outline-none transition-colors ${darkMode ? 'bg-gray-800 border-gray-700 text-white placeholder-gray-500' : 'bg-white border-gray-200 text-gray-800'}`} />
              </div>
              <div className="grid grid-cols-3 gap-2">
                <input type="text" inputMode="numeric" placeholder="Cuota" value={newDebtMonthly} onChange={e => setNewDebtMonthly(formatInputCurrency(e.target.value))} className={`p-3 border rounded-xl text-sm outline-none transition-colors ${darkMode ? 'bg-gray-800 border-gray-700 text-white placeholder-gray-500' : 'bg-white border-gray-200 text-gray-800'}`} />
